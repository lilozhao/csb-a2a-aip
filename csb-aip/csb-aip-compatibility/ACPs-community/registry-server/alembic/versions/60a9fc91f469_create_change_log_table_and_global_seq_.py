...
down_revision: str | None = "b49f5453e252"
...
def upgrade() -> None:
    ...
    # 设置seq列的默认值为序列的下一个值
    op.execute("ALTER TABLE change_log ALTER COLUMN seq SET DEFAULT nextval('global_seq')")
    ...
    op.create_index(op.f("ix_change_log_version"), "change_log", ["version"], unique=False)
