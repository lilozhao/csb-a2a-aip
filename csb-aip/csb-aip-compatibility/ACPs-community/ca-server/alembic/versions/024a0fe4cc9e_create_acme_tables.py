...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("key_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    op.create_index(op.f("ix_acme_accounts_key_id"), "acme_accounts", ["key_id"], unique=True)
    op.create_table(
        "acme_nonces",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("nonce", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    op.create_table(
        "acme_orders",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("order_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        ...
        sa.Column("finalize", sqlmodel.sql.sqltypes.AutoString(length=512), nullable=True),
        sa.Column("certificate", sqlmodel.sql.sqltypes.AutoString(length=512), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.Column("expires", sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f("ix_acme_orders_order_id"), "acme_orders", ["order_id"], unique=True)
    op.create_table(
        "acme_authorizations",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("authz_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    op.create_table(
        "acme_certificates",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("cert_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column("order_id", sa.Integer(), nullable=False),
        sa.Column(
            "serial_number",
    ...
    op.create_table(
        "acme_challenges",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("challenge_id", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_acme_authorizations_authz_id"), table_name="acme_authorizations")
