...
IMAGE_NAME="acps-demo-partners"
RELEASE_NAME="demo-partner-${VERSION}"
...
mkdir -p "${STAGING_DIR}/lib" "${STAGING_DIR}/partners" "${STAGING_DIR}/provision_tools"
...
cp -R "${PROJECT_DIR}/partners/online" "${STAGING_DIR}/partners/online"
